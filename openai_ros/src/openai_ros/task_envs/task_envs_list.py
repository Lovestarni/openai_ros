...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    elif task_env == 'WamvNavPoint-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.wamv_diff.wamv_nav_point:WamvNavPointEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.wamv_diff import wamv_nav_point
    elif task_env == 'WamvNavPoint-v1':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.wamv_diff.wamv_nav_point_v1:WamvNavPointEnv',
            max_episode_steps=max_episode_steps,
        )
    ...
    elif task_env == 'WamvNavPoints-v2':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.wamv_diff.wamv_nav_points_v2:WamvNavPointsEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.wamv_diff import wamv_nav_points_v2
    elif task_env == 'WamvNavPoints-v3':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.wamv_diff.wamv_nav_points_v3:WamvNavPointsEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.wamv_diff import wamv_nav_points_v3
